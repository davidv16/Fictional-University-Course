<?php
  ...
  function deleteLike($data) {
    ...
    // if the current user id matches the post_author and the id of the like
    // and the posttype with the id number provided is 'like'
    if(get_current_user_id() == get_post_field('post_author', $likeId) AND
    get_post_type($likeId) == 'like') {
      //wp function to delete post, gets the post id and true lets it skip the trash
